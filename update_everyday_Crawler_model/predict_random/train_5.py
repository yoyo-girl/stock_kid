...
def train_5_rf(df):
    ...
    data = pd.DataFrame(data, columns=['open', 'high', 'low', 'close', 'volume','week_trend'])#, 'macd', 'week_trend', 'slowk', 'slowd' ,'mom','MA_5', 'MACD_9', 'RSV_9', 'K_values', 'D_values', 'Mean_Volume_15'])#, 'sma_con', 'rsi2' ,'mom', 'slowk', 'slowd','macd2','macd2','mom_2'
    #, 'sma_con', 'rsi2','macd2'
